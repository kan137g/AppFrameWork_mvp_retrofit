package com.kangwencai.common.net_retrofit;
...
import com.kangwencai.common.net_retrofit.cookie.CookieJarImpl;
import com.kangwencai.common.net_retrofit.cookie.store.MemoryCookieStore;
import com.kangwencai.common.net_retrofit.rest.HttpsUtils;
import com.kangwencai.common.net_retrofit.rest.ItemTypeAdapterFactory;
import com.kangwencai.common.net_retrofit.service.APIManagerService;
...
public class RetrofitRest {
    public static final String BASE_URL = IConstants.baseUrl;
    ...
    public RetrofitRest(Context context) {
        apiManagerService = getInstance(context).create(APIManagerService.class);
    }
...
//                    .addConverterFactory(StringconverterF)
    ...
    private static OkHttpClient initClient(Context context) {
        ...
        try {
            //12306的证书
            streams[0] = context.getAssets().open("srca.cer");
//            streams[0] = context.getAssets().open("zhy_server.cer");
