package com.kangwencai.business.model.biz;

import android.os.Handler;

import com.google.gson.Gson;
import com.kangwencai.business.model.bean.zhihu.ZhiHuDaily;
import com.kangwencai.business.model.bean.zhihu.ZhihuStory;
...
//    }
    ...
    public void getStoryDataByRetrofit(final INetCallBack<ArrayList<ZhihuTopStory>> eventLister) {
        RetrofitRestBusiness.getInstance().getZhihuDailyRetrofitOnly2().enqueue(new Callback<ZhiHuDaily>() {
            @Override
